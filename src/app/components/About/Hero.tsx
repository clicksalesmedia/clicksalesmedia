  ...
  return (
    <section className="min-h-max bg-primaryColor dark:bg-gray-950">
            <div className="relative mx-auto pt-32 pb-24 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
                <div className="text-left grid lg:grid-cols-3 p-6 rounded-2xl bg-gradient-to-tr from-secondaryColor to-[#b58e5e] dark:from-gray-900 dark:to-gray-800 border border-[#b58e5e] dark:border-gray-800 max-w-2xl lg:max-w-5xl mx-auto lg:divide-x divide-y lg:divide-y-0 divide-gray-300 dark:divide-gray-800">
