...
return (
  ...
  <div className="rounded-md">
    <Image className="rounded-md" src="/mounir-clicksalesmedia.jpg" width={300} height={500} alt='clicksalesmedia ceo' />
  </div>
</div>
                    </div>
                    <div className="space-y-3 lg:space-y-6">
                        <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-4 bg-secondaryColor dark:bg-gray-900 border border-[#966d3b]/80 dark:border-gray-900/80 rounded-lg">
