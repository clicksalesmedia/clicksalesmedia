...
export default function NewHero() {
    ...
    return (
        <>
            <section className="py-8 mt-24 bg-cover bg-center relative" style={{ backgroundImage: 'url("mesh-clicksalesmedia.png")' }}>
                <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row lg:items-stretch gap-10">
                    ...
                    <div className="lg:w-1/2 lg:py-10 xl:py-12 text-center lg:text-left max-w-2xl md:max-w-3xl mx-auto ">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                            ...
                            <Link href="/schedule-a-meeting" className="flex items-center justify-center gap-x-2 px-5 py-1.5 font-semibold border border-secondaryColor text-secondaryColor dark:border-secondaryColor dark:text-white" aria-label="Schedule a meeting with our marketing team">
                                {t('nav.scheduleAMeeting')}
                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-browser-safari" viewBox="0 0 16 16" aria-hidden="true">
