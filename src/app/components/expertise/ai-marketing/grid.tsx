  ...
  return (
    <section className='p-5 md:p-20'>
      <div className="container px-2 md:px-6 m-auto">
        <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-12 border border-neutral-400 border-opacity-30">
      ...
      <div className="container px-2 md:px-6 m-auto">
        <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-12 border-t-0 border border-neutral-400 border-opacity-30">
