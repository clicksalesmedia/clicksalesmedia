      ...
      <div className="px-6 m-auto">
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12">
          ...
          <div className="col-span-4 lg:col-span-6 relative">
            <img src="/expertise/branding/brandstrategy.jpg" alt="Branding & Brand Strategy" className="w-full h-full object-cover" />
          ...
          <div className="col-span-4 lg:col-span-6 relative">
            <img src="/brandguidlines.jpg" alt="Brand Stationery Design" className="w-full h-full object-cover" />
