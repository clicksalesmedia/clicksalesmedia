...
const Box: React.FC<BoxProps> = ({ front, bottom, back, top }) => {
  return (
    ...
    >
      {/* FRONT */}
      <span className="absolute flex h-full w-full items-center justify-center border-2 border-[#B2834F] bg-secondaryColor text-white">
        {front}
      </span>
      ...
      <span
        ...
        className="absolute flex h-full w-full origin-top items-center justify-center border-2 border-[#B2834F] bg-secondaryColor text-white"
      >
        {bottom}
      </span>
      ...
      <span
        style={{ transform: "translateY(-5rem) rotateX(90deg)" }}
        className="absolute flex h-full w-full origin-bottom items-center justify-center border-2 border-[#B2834F] bg-secondaryColor text-white"
      >
        {top}
      </span>
      ...
      <span
        ...
        className="absolute flex h-full w-full origin-center items-center justify-center border-2 border-[#B2834F] bg-secondaryColor text-white"
      >
        {back}
      </span>
    </motion.span>
