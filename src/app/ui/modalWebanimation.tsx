...
const FormService: FunctionComponent<FormServiceProps> = ({ isOpen, setIsOpen, buttonText }) => {
  ...
  const [form, setForm] = useState({
    ...
    website: '',
    mobile: '',
    package: 'Premium', // Default service or could be empty string ''
    email: '',
  });
            ...
            <div className="relative z-10">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <Select id="package" name="package" value={form.package} onChange={handleChange} style={{ background: '#222222',color:'#C3A177', borderColor: '#C3A177', borderRadius:1}}>
